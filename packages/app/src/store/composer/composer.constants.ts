...
export const CREATE_RECIPIENT_WITH_AMOUNT = 'CREATE_RECIPIENT_WITH_AMOUNT'
export const UPDATE_RECIPIENT_AMOUNT = 'UPDATE_RECIPIENT_AMOUNT'
export const CREATE_SOLVER = 'CREATE_SOLVER'
export const ADD_RECIPIENT_WITH_AMOUNT = 'ADD_RECIPIENT_WITH_AMOUNT'
