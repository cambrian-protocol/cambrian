...
async function main() {
  ...
  const IPFSSolutionsHub = new ethers.Contract(
  ...
  await IPFSSolutionsHub.connect(user1).createSolution(
    solutionId,
    ToyToken.address,
    solverConfigs,
  ...
  console.log("Created Solution with ID: ", solutionId, " and cid: ", cid);
}
