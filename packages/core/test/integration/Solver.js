...
const solverabi =
  require("../../artifacts/contracts/solvers/BasicSolverV1.sol/BasicSolverV1.json").abi;
const solverlibabi =
  require("../../artifacts/contracts/solvers/SolverLib.sol/SolverLib.json").abi;
const ctabi =
  require("../../artifacts/contracts/conditionalTokens/ConditionalTokens.sol/ConditionalTokens.json").abi;
const phubabi =
  require("../../artifacts/contracts/hubs/ProposalsHub.sol/ProposalsHub.json").abi;
...
describe("Solver", function () {
  ...
  it("Should execute single-solver Proposal with two outcomes", async function () {
    let abi = ["event ErrorHandled(string)"];
    ...
    const log = iface.parseLog({
      data: "0xe7ea40a5328878bc30495ead64dfb03cdab66e61ea1a0baeecd44d0e5f1a4ad7",
      topics: [
        "0xabe14211ae2537ee6b7aa77dde5785f740f88443cc6f3a4a4b68bb0e6a5652fa",
      ],
    });
    ...
    console.log(
      ethers.utils.defaultAbiCoder.decode(
        ["bytes32"],
        "0xe7ea40a5328878bc30495ead64dfb03cdab66e61ea1a0baeecd44d0e5f1a4ad7"
      )
    );

    console.log(
      "topic: ",
      ethers.utils.keccak256(ethers.utils.toUtf8Bytes("IngestedData()"))
    );
