...
describe("It should all work", async function () {
  ...
  // it("Should allow a retry from Solver0 (with reduced total funds for retry) in a 2-solver proposal", async function () {
  //   //Create solution
  //   const solutionId = ethers.utils.formatBytes32String("TestID")
  ...
  //       key: 1,
  //       solverIndex: 0,
  //       data: ethers.utils.defaultAbiCoder.encode(['address'], [this.buyer.address]) // WRITE A FUNCTION TO GET TOKEN BALANCE
  //     },
  //     {
  //       executions: 0,
  //       isDeferred: false,
