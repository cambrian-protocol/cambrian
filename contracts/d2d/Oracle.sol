...
//     event UpdatedTimeLock(uint256 positionId, uint256 indexed newTimeLock);
...
//     uint256 public _binaryOutcomeSlots = 2;
//     uint256[] public _binaryIndexSets = [1, 2];
//     uint256[] public _binaryPartition = [1, 2];
//     uint256[] public _successPartition = [0, 1];
//     uint256[] public _failPartition = [1, 0];
...
//         require(
//             _conditionalTokens != ConditionalTokens(0),
//             "Oracle: conditionalTokens cannot be null"
//         );
//         require(
//             _ctfTreasury != CtfTreasury(0),
//             "Oracle: ctfTreasury cannot be null"
//         );
//         ctfTreasury = _ctfTreasury;
//         conditionalTokens = _conditionalTokens;
//     }
...
//         address _jv
//     ) external protected {
//         daoQuestions[_positionId] = Questions(
//             _questionId,
//             _timeLockFinish,
//             _dao,
//             _balance,
...
//         require(
//             block.timestamp >=
//                 daoQuestions[_successPositionId[0]].timeLockFinish,
//             "Oracle: current timestamp < timelock"
//         );
//         uint256 jvBalanceOne = conditionalTokens.balanceOf(
//             daoQuestions[_successPositionId[0]].jv,
//             _successPositionId[0]
//         );
//         uint256 jvBalanceTwo = conditionalTokens.balanceOf(
//             daoQuestions[_successPositionId[1]].jv,
//             _successPositionId[1]
//         );
//         /* solhint-disable-next-line max-line-length */
//         if (
//             jvBalanceOne == daoQuestions[_successPositionId[0]].balance &&
//             jvBalanceTwo == daoQuestions[_successPositionId[1]].balance
//         ) {
...
//      */
//     function updateTimeLock(uint256 _newTimeLock, uint256 _positionId)
//         external
//         protected
//     {
//         require(
//             msg.sender == daoQuestions[_positionId].jv,
//             "Oracle: caller must be joint venture wallet for position"
//         );
//         require(
//             _newTimeLock >= block.timestamp,
//             "Oracle: must be greater than current timestamp"
//         );
//         require(
